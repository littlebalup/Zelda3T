...
void Texte::chercheText() {
    ...
    switch (id) {
        ...
        case 46 : texte = "TUTORIEL : Appuyez sur Cercle près de quelqu'un pour lui parler, ou près d'une pancarte pour la lire."; break;
        ...
        case 591 : texte = "En appuyant sur D-Pad haut, tu peux voir les monstres déjà répertoriés. Tu n'as qu'à vaincre un monstre pour qu'il soit ajouté."; idsuiv=592; break;
        case 592 : 
        ...
        case 1035: texte = "TUTORIEL : Appuyez sur Cercle près d'un coffre pour l'ouvrir. Un coffre ne s'ouvre que par le bas."; break;
        ...
        case 1376: texte = "Salut, moi c'est Raiden. J'suis le dessinateur de l'équipe. Je me suis occupé de l'écran titre et des illustrations (... et aussi des nuages sur les maps m'enfin on s'en fou un peu...)."; idsuiv=1377; break;
